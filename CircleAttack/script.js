...
/*
This functionresets the enemy and players X & Y position. We call this function before we
start the game
*/
function resetGame() {
...
// -- need to implement drawClickToPlay and checkWalls and it should be good